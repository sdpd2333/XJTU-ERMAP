...
for index=1:length(EsN0)
    Input_symbols = randsrc(2,Datasize/2,[0:(M-1)]);                %生成信源数据流
...
figure(1)
semilogy(EsN0,ber1,'-ro')
%axis([0 15 10^-4 1]) 
grid on
legend('2发1收Alamouti方案')
xlabel('信噪比Es/N0')
ylabel('误比特率（BER）')
title('Alamouti方案在准静态瑞利衰落信道下的误码率性能')
save('data_singleRX_QPSK.mat','EsN0','ber1');
%save('data_singleRX_8QAM.mat','EsN0','ber1');
%save('data_singleRX_16QAM.mat','EsN0','ber1');
